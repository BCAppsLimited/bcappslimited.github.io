...
# Hero section
title: Bulk Delete
description: Bulk Delete is a tool for making it easy to delete multiple records in one go. Useful when the list page only allows deleting one record at a time.
...
- Go to the [Bulk Delete Product Page](https://appsource.microsoft.com/en-us/product/dynamics-365-business-central/PUBID.bcappslimited1693858041247%7CAID.bulk-delete%7CPAPPID.f6ed7976-9eb2-4854-b0e3-ab8a4a3f23ea?tab=Overview) on AppSource.
- Checkout the full [Bulk Delete Online Help](https://docs.bcapps.co/BulkDelete).
